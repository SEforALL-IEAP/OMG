    ...
    def get_lcoe(self, energy_per_cell, people, num_people_per_hh, start_year, end_year, new_connections,
        ...
        if get_investment_cost:
            ...
            return capital_investment / discount_factor[step] if self.grid_capacity_investment == 0 else \
                self.grid_capacity_investment * peak_load / discount_factor[step], installed_capacity
...
class SettlementProcessor:
    ...
    def elec_current_and_future(self, elec_actual, elec_actual_urban, elec_actual_rural, pop_tot, start_year,
                                min_night_lights=0, min_pop=100, max_transformer_dist=20, max_mv_dist=15, max_hv_dist=50):
        """
        ...
        #print (self.df[SET_ELEC_POP_CALIB].sum())
